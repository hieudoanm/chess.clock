# ⏱️ [Chess](https://hieudoanm.github.io/chess/)

## 📚 Table of Contents

- [⏱️ [Chess](https://hieudoanm.github.io/chess/)](#️-chess-clockhttpshieudoanmgithubiochessclock)
...
Chess Clock is a dedicated timer application for chess games, helping players manage time controls with a clean and focused interface.

## ✨ 2. Features

1. [x] Dual-player chess timer
2. [x] Common time controls (e.g. blitz, rapid, classical)
3. [x] Time increment support
4. [x] Pause and reset controls
5. [x] Web, CLI, mobile, and desktop distribution targets

## 🎥 3. Demo

- 🌐 [Live Demo](https://hieudoanm.github.io/chess/)

## 🚀 4. Usage

- 🌐 [Web](https://hieudoanm.github.io/chess/)
- 💻 [CLI](https://github.com/hieudoanm/chess/releases)
- 📱 [Mobile](https://github.com/hieudoanm/chess/releases)
- 🖥️ [Desktop](https://github.com/hieudoanm/chess/releases)
  - 🍎 [MacOS](https://github.com/hieudoanm/chess/releases/tag/macos-latest)
  - 🐧 [Ubuntu](https://github.com/hieudoanm/chess/releases/tag/ubuntu-latest)
  - 🪟 [Windows](https://github.com/hieudoanm/chess/releases/tag/windows-latest)
